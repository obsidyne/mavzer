  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="pt-[66px] border-b border-[#dde4ef]">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-7 sm:py-10">
          ...
          <p className="text-[12px] sm:text-[13px] text-[#9aa3af] mt-1">{t.contact_subtitle}</p>
        </div>
      </div>

      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-14" id="form">

        {/* Form card */}
        <div className="bg-white border border-[#dde4ef] rounded-xl shadow-[0_2px_24px_rgba(7,30,61,0.06)] p-5 sm:p-10 mb-10 sm:mb-16">
          <h2 className="font-condensed text-[20px] sm:text-[22px] font-extrabold uppercase text-[#071e3d] mb-1">
            {t.form_title}
          </h2>
          <p className="text-[12px] sm:text-[13px] text-[#9aa3af] mb-6 sm:mb-8">{t.form_subtitle}</p>
          ...
          {sent ? (
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              <input
                ...
                placeholder={t.form_name} required
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <input
                  ...
                  placeholder={t.form_email} required
                  className="w-full border border-[#dde4ef] rounded px-4 py-3 text-[13px] text-[#071e3d] placeholder:text-[#b0b8c4] outline-none focus:border-[#0a4c8a] focus:shadow-[0_0_0_3px_rgba(10,76,138,0.08)] transition-all"
                />
                <input
              ...
              <textarea
                ...
                placeholder={t.form_message} rows={5} required
              ...
              <div className="flex justify-center mt-2">
                <button
                  ...
                  className="w-full sm:w-auto bg-[#0a4c8a] text-white font-bold tracking-[0.15em] uppercase text-[12px] px-12 py-3 rounded hover:bg-[#071e3d] transition-colors disabled:opacity-60 active:scale-[0.97]"
                >
        ...
        {/* Contact details + map — stacked on mobile, side-by-side on md+ */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 sm:gap-8 items-start">
          <div>
            <h2 className="font-condensed text-[18px] sm:text-[20px] font-extrabold uppercase text-[#071e3d] mb-5 sm:mb-6">
              {t.contact_label}
            </h2>
          ...
          {/* Map — full width on mobile, natural height */}
          <div
            className="rounded-xl overflow-hidden border border-[#dde4ef] shadow-[0_2px_16px_rgba(7,30,61,0.06)] w-full"
            style={{ height: 300 }}
          >
            <iframe
