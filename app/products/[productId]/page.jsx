  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        // recommended: other products in same sector
      ...
      <div className="max-w-5xl mx-auto px-8 py-8">
        ...
        {loading ? (
          ...
          <div className="bg-white rounded-xl border border-[#dde4ef] p-12 text-center">
            ...
            <Link href="/products" className="mt-3 inline-block text-[#1e88e5] text-sm font-semibold">← Ürünlere Dön</Link>
          </div>
        ) : (
          <>
            {/* main product card */}
                ...
                <div className="flex-1 p-7 flex flex-col">
                  ...
                  {display?.price && (
                    <div className="mt-4 py-3 border-t border-[#f0f3f8]">
                      <span className="text-[10px] font-bold tracking-[0.15em] uppercase text-[#9aa3af]">Birim Fiyat</span>
                  ...
                  {recommended.map((rec) => (
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        {rec.description && (
                          <p className="text-[11px] text-[#9aa3af] line-clamp-2 leading-relaxed">{rec.description}</p>
                        )}
                        <div className="mt-3 pt-3 border-t border-[#f0f3f8] flex items-center justify-between">
                          {rec.price
                            ...
                            : <span className="text-[11px] text-[#9aa3af]">{rec._count?.subProducts ?? 0} varyant</span>
                          }
