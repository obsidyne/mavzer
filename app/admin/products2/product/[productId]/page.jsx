// PAGE: /admin/products2/product/[productId]
// productId = "new"  → create form
//   ?isGroup=1       → create a product group instead
// productId = <id>   → edit form
//
// Key difference from /admin/products/product/[id]:
//   - No categoryId or parentId required when creating at depth 0
//   - Uses POST /api/products/standalone for new depth-0 products
//   - parentId is still passed when creating sub-products from a group page
...
export default function Products2FormPage() {
  ...
  const isGroupParam = searchParams.get("isGroup") === "1";
  ...
  async function handleSubmit(e) {
    ...
    try {
      const isCreatingGroup = isNew ? creatingGroup : isGroup;
  ...
  const pageTitle = isNew
    ? (showingGroup ? "New Product Group" : "New Product")
    : (showingGroup ? "Edit Product Group" : "Edit Product");

  const backLabel = parentId ? "← Back to group" : "← Back to products";
